  ...
  async sendPasswordChangedEmail(email) {
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>If you didn't update your password, please reset it immediately and contact support.</p>
        <p style="color: #6b7280; font-size: 14px;">Need help? Reply to this email and our team will assist you.</p>
      </div>
    `
